...
| Версия | Дата | Ссылка |
|--------|------|--------|
| **v1.0.9** | 2024-07-01 | [⬇️ zvukopad.exe](https://github.com/DidimoonYT/zvukopad/releases/download/v1.0.9/zvukopad.exe) |
...
> ℹ️ Начиная с v1.0.9 файл в релизах называется просто `zvukopad.exe` (без версии в имени).
